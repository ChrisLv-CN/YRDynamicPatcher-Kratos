...
namespace ExtensionHooks
{
    public class WarheadTypeExtHooks
    {
        ...
        static public unsafe UInt32 WarheadTypeClass_CTOR(REGISTERS* R)
        {
            return WarheadTypeExt.WarheadTypeClass_CTOR(R);
        }

        [Hook(HookType.AresHook, Address = 0x75E5C8, Size = 6)]
        static public unsafe UInt32 WarheadTypeClass_SDDTOR(REGISTERS* R)
        {
        ...
        static public unsafe UInt32 WarheadTypeClass_LoadFromINI(REGISTERS* R)
        {
        ...
        static public unsafe UInt32 WarheadTypeClass_SaveLoad_Prefix(REGISTERS* R)
        {
            return WarheadTypeExt.WarheadTypeClass_SaveLoad_Prefix(R);
        }

        [Hook(HookType.AresHook, Address = 0x75E2AE, Size = 7)]
        static public unsafe UInt32 WarheadTypeClass_Load_Suffix(REGISTERS* R)
        {
            return WarheadTypeExt.WarheadTypeClass_Load_Suffix(R);
        }

        [Hook(HookType.AresHook, Address = 0x75E39C, Size = 5)]
        static public unsafe UInt32 WarheadTypeClass_Save_Suffix(REGISTERS* R)
        {
