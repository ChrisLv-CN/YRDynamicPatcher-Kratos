...
namespace PatcherYRpp
{
    ...
    public struct Surface
    {
        ...
        public unsafe void DrawSHP(Pointer<ConvertClass> Palette, Pointer<SHPStruct> SHP, int frameIdx,
            Pointer<Point2D> pos, Pointer<RectangleStruct> boundingRect, BlitterFlags flags, uint arg7,
            int zAdjust, uint arg9, int extraGlow, int tintColor,
            Pointer<SHPStruct> BUILDINGZ_SHA, uint argD, int ZS_X, int ZS_Y)
        {
            var func = (delegate* unmanaged[Thiscall]<int, ref Surface, IntPtr, IntPtr, int,
                IntPtr, IntPtr, BlitterFlags, uint,
                int, uint, int, int,
                IntPtr, uint, int, int, void>)ASM.FastCallTransferStation;
            func(0x4AED70, ref this, Palette, SHP, frameIdx,
                pos, boundingRect, flags, arg7,
                zAdjust, arg9, extraGlow, tintColor,
                BUILDINGZ_SHA, argD, ZS_X, ZS_Y);
        }

        public unsafe void DrawSHP(Pointer<ConvertClass> Palette, Pointer<SHPStruct> SHP, int frameIdx,
            Pointer<Point2D> pos, Pointer<RectangleStruct> boundingRect, BlitterFlags flags = (BlitterFlags)0x600, int extraGlow = 1000, int tintColor = 0)
        {
            DrawSHP(Palette, SHP, frameIdx,
                pos, boundingRect, flags,
                0, 0, 0, extraGlow, tintColor,
                Pointer<SHPStruct>.Zero, 0, 0, 0);
        }

        public unsafe void DrawSHP(Pointer<ConvertClass> Palette, Pointer<SHPStruct> SHP, int frameIdx,
            Point2D pos, RectangleStruct boundingRect, BlitterFlags flags = (BlitterFlags)0x600, int extraGlow = 1000, int tintColor = 0)
        {
            DrawSHP(Palette, SHP, frameIdx,
                Pointer<Point2D>.AsPointer(ref pos), Pointer<RectangleStruct>.AsPointer(ref boundingRect), (BlitterFlags)0x600,
                0, 0, 0, extraGlow, tintColor,
                Pointer<SHPStruct>.Zero, 0, 0, 0);
        }

        public unsafe void DrawText(string text, Pointer<Point2D> pLocation, ColorStruct color)
        {
