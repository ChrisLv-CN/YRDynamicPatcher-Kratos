...
namespace Extension.Ext
{
    ...
    public partial class TechnoExt
    {
        ...
        public unsafe void TechnoClass_Init_FixGattlingStage()
        {
            Pointer<TechnoClass> pTechno = OwnerObject;
            Pointer<TechnoTypeClass> pType = pTechno.Ref.Type;
            if (pType.Ref.IsGattling && pType.Ref.WeaponStages > 1)
            {
                OnUpdateAction += TechnoClass_Update_FixGattlingStage;
            }
        }
        ...
        {
            Pointer<TechnoClass> pTechno = OwnerObject;
            Pointer<TechnoTypeClass> pType = OwnerObject.Ref.Type;
